...
git remote set-url --add --push origin https://np@scm.icebergsys.net/git/projects/chemlogic-android
git remote set-url --add --push origin https://nicholaspaun@github.com/nicholaspaun/chemlogic-android.git
